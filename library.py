...
#This is a list that is made up of dictionaries with key value pairs. You can tell by the list being in square brackets[] and the dictionaries being in curly brackets{}
...
#no return does not print anthing
count_books()
